...
#import "JUIAppDelegate.h"

#import "JUIContainerViewController.h"

@interface JUIAppDelegate ()

@end

@implementation JUIAppDelegate
...
{
    JUIContainerViewController *containerController = [JUIContainerViewController new];
